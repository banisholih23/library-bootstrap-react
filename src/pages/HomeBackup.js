    ...
    return (
      <>
        <Row className="h-100 no-gutters">
          <Col md={2} className="sidebar rounded">
            <div className="profile">
              <div className="d-flex flex-column justify-content-beetween pt-2">
                <img className="profile-img pl-2 pr-2 mt-2" src={profile} alt="profile-image" />
                <h4 className="d-flex align-items-center pl-5 pt-2 text-dark">Bani Sholih</h4>
              </div>
            </div>
            <Navbar className="navbar-sidebar pr-5 mr-3 flex-column justify-content-beetween mt-4" light expand="md">
          ...
          <Col md={10} className="content">
            <div className="navbar shadow p-3 mb-5 rounded ml-3">
